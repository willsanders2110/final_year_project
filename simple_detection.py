...
from dl4cv.utils.simple_obj_det import image_pyramid
from dl4cv.utils.simple_obj_det import sliding_window
from dl4cv.utils.simple_obj_det import classify_batch
