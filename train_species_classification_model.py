# python train_species_classification_model.py --dataset datasets/species_classification_images
...
print(classification_report(testY.argmax(axis=1), predictions.argmax(axis=1), target_names=["Basil", "Mint",
                                                                                            "Rosemary", "Thyme"]))
